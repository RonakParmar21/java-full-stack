...
public class BookingService {
    ...
    public BookingService() {
        ...
        trainList.add(new Train(102, "Satabdi Express", "Delhi", "Mumbai", 60));
        trainList.add(new Train(103, "Durunto Express", "Aagra", "Delhi", 70));
    ...
    // Homework :- date based search put on searchTrain functionality.
